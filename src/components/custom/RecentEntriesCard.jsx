    ...
    return (
        <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg">
            <CardHeader className="pb-4">
                <CardTitle className="text-lg text-gray-800">Recent Entries ({journalData.length})</CardTitle>
            </CardHeader>
                ...
                {journalData.map((entry, index) => (
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-medium text-gray-600">{entry.createdAt}</span>
                            <Badge
                                variant="outline"
                                style={{
